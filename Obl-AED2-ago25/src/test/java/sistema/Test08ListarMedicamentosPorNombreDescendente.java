...
public class Test08ListarMedicamentosPorNombreDescendente {
    ...
    void ListarMedicamentoVacio() {
        retorno = s.listarMedicamentosPorNombreDescendente();
    ...
    void ListarMedicamentoUnoSolo() {
        ...
        retorno = s.listarMedicamentosPorNombreDescendente();
        assertEquals(Retorno.Resultado.OK, retorno.getResultado());
        assertEquals(Salidas.MED03, retorno.getValorString());
    }
